...
$shopphone=$_SESSION['phone'];
$sqlshopname="select * from shopdetails where phone='$shopphone'";
$sqlshopnamevalue=$connect->select($connection,$sqlshopname);
$sqlshopnamevaluedata=$connect->fetchdata($sqlshopnamevalue);
$shophistory=$sqlshopnamevaluedata['shopname'].'history';


$sqlcusthistory="select * from $shophistory";
  ...
  <?php while($sqlcusthistoryvaluedata=$connect->fetchData($sqlcusthistoryvalue)){
    ...
    ?>
        ...
        <tr>
          ...
          <td><?php echo $sqlcusthistoryvaluedata['token'] ?> </td>
